...
CMD ["java", "-jar", "-Xmx8g", "-XX:+UseG1GC", "-XX:G1HeapRegionSize=32m", "-XX:MaxGCPauseMillis=200", "-XX:+UseStringDeduplication", "/opt/phaedra/service.jar", "--spring.jmx.enabled=false"]
