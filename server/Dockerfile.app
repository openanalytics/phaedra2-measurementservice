...
CMD ["java", "-jar", "-Xmx8g", "-XX:+UseG1GC", "-XX:+PrintGCDetails", "-XX:+PrintGCTimeStamps", "-XX:+PrintStringDeduplicationStatistics", "/opt/phaedra/service.jar", "--spring.jmx.enabled=false"]
