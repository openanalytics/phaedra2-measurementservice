...
CMD ["java", "-jar", "-Xms2g", "-Xmx4g", "-XX:+UseG1GC", "-XX:MaxGCPauseMillis=100", "-XX:+ParallelRefProcEnabled", "-XX:+AlwaysPreTouch", "/opt/phaedra/service.jar", "--spring.jmx.enabled=false"]
